...
const Nav = () => {
  return (
    <div className="sticky top-0 z-50 bg-white">
      <nav className="container mx-auto flex justify-between items-center gap-2 py-4 px-4">
        ...
        <div className="flex gap-2">
          ...
          <button className="btn btn-secondary h-8 bg-linear-to-r from-[#F97316] to-[#EC4899] text-white py-2 px-6 rounded-lg cursor-pointer border-0">
            Sign Up
          </button>
        </div>
      </nav>
